...
namespace ModBuilding.Editor
{
    internal class ModBuilder
    {
        ...
        public void Build()
        {
            ModBuilderStopwatch.Global.Restart();
            ...
            ModBuilderStopwatch.LogGlobal();
            ModBuilderStopwatch.LogAll();
        }

        private static bool TryBuildProject(string buildPath)
        {
            ModBuilderStopwatch.Local.Restart();
            ...
            var flag = BuildPipeline.BuildPlayer(buildOptions).summary.result == BuildResult.Succeeded;
            ModBuilderStopwatch.LogLocal("TryBuild");
            return flag;
        }
        ...
        private void BuildMod(ModDefinition modDefinition, string buildPath)
        {
            ...
            ModBuilderStopwatch.LogLocal("_assetBundleBuilder");
        }
    }
}