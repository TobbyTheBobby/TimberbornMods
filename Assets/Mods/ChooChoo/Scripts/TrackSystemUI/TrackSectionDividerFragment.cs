...
namespace ChooChoo.TrackSystemUI
{
    internal class TrackSectionDividerFragment : IEntityPanelFragment
    {
        ...
        public void ShowFragment(BaseComponent entity)
        {
            ...
            if (!_oneWayTrack || !_oneWayTrack.enabled)
                return;
            _root.ToggleDisplayStyle(true);
            _sectionDividerToggle.SetValueWithoutNotify(_oneWayTrack._dividesSection);
            ...
            _changeDirectionButton.ToggleDisplayStyle(_oneWayTrack._dividesSection);
        }
