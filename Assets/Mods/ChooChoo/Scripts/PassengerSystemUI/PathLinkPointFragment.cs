...
//                     }))
//                 .AddComponent((Action<VisualElementBuilder>)(builder => builder.SetWidth(new Length(100f, LengthUnit.Percent))
//                     .SetJustifyContent(Justify.Center).AddPreset((Func<UiPresetFactory, VisualElement>)(builder =>
//                     {
//                         var localizableButton = builder.Buttons().ButtonGame();
...
//         {
//             var component = entity.GetComponentFast<PassengerStation>();
