...
namespace ChooChoo.GoodsStations
{
    internal class ObtainGoodWorkplaceBehavior : WorkplaceBehavior
    {
        ...
        {
            return _goodService.Goods.Any(good =>
                agent.GetComponentFast<CarrierInventoryFinder>().TryCarryFromAnyInventory(good, _inventory, CanObtainFrom));
        }
        ...
        private static bool CanObtainFrom(Inventory inventory)
        {
            ...
            var cannotObtainFrom =
                (componentFast1 != null && componentFast1.GoodObtainingEnabled) || (componentFast2 != null && componentFast2.GoodObtainingEnabled);
