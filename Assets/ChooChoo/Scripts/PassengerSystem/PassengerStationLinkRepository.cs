...
namespace ChooChoo
{
  public class PassengerStationLinkRepository : IPostLoadableSingleton, ITickableSingleton
  {
    ...
    PassengerStationLinkRepository(TrainDestinationConnectedRepository trainDestinationConnectedRepository, TrainDestinationService trainDestinationService, EventBus eventBus)
    {
