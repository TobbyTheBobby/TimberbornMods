...
namespace ChooChoo.PassengerSystemUI
{
    public class ConnectPathLinkPointButton
    {
        ...
        {
            var component = gameObject.GetComponent<PassengerStation>();
            ...
            return _passengerStationLinkRepository.AlreadyConnected(component, passengerStation)
                ? _loc.T(PickPathLinkPointAlreadyConnectedLocKey)
                : "";
        }
