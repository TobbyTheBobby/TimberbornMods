...
namespace ChooChoo.NavigationSystem
{
    ...
    {
        public void CalculateTrackRouteWeight(
            TrackRoute previousTrackRoute,
            TrackPiece destinationTrackPiece,
            Dictionary<TrackRoute, int?> trackRouteWeights,
            ...
            ref int? maxDistance)
        {
            ...
            foreach (var trackRoute in previousTrackRoute.Exit.ConnectedTrackRoutes
                         ...
                         .OrderBy(trackRoute =>
                             Vector3.Distance(trackRoute.Exit.ConnectedTrackPiece.CenterCoordinates, destinationTrackPiece.CenterCoordinates))
                    )
            {
        ...
        private static bool UpdateWeight(TrackRoute previousTrackRoute, int currentDistance, IDictionary<TrackRoute, int?> trackRouteWeights)
        {
